  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb', padding: '20px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', backgroundColor: 'white', borderRadius: '8px', padding: '40px', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#1f2937', marginBottom: '20px' }}>Terms of Service</h1>
        <p style={{ color: '#6b7280', marginBottom: '30px' }}>Last updated: December 16, 2024</p>
        
        <div style={{ lineHeight: '1.6', color: '#374151' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>Welcome to Cush</h2>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>Services Provided</h2>
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>Core Services</h3>
          ...
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>Platform Features</h3>
          <ul style={{ marginLeft: '20px', marginBottom: '15px' }}>
          ...
          <div style={{ backgroundColor: '#fef3cd', border: '1px solid #f59e0b', borderRadius: '6px', padding: '15px', margin: '20px 0' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>User Responsibilities</h2>
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>Prohibited Conduct</h3>
          <ul style={{ marginLeft: '20px', marginBottom: '15px' }}>
          ...
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>Information Accuracy</h3>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>AI Assistant (Imisi) Usage</h2>
          <div style={{ backgroundColor: '#fef3cd', border: '1px solid #f59e0b', borderRadius: '6px', padding: '15px', margin: '15px 0' }}>
            <p style={{ color: '#92400e', fontSize: '0.875rem' }}>
          ...
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>Guidelines for AI Use</h3>
          <ul style={{ marginLeft: '20px', marginBottom: '15px' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>Payments and Fees</h2>
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>Service Fees</h3>
          <ul style={{ marginLeft: '20px', marginBottom: '15px' }}>
          ...
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>Payment Processing</h3>
          <p style={{ marginBottom: '15px' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>Disclaimers and Limitation of Liability</h2>
          <div style={{ backgroundColor: '#fef3cd', border: '1px solid #f59e0b', borderRadius: '6px', padding: '15px', margin: '15px 0' }}>
            <p style={{ color: '#92400e', fontSize: '0.875rem' }}>
          ...
          <h3 style={{ fontSize: '1.2rem', fontWeight: '500', marginTop: '20px', marginBottom: '10px' }}>No Professional Advice</h3>
          <p style={{ marginBottom: '10px' }}>Cush and its AI assistant do not provide:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px' }}>
